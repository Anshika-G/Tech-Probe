...
<button id="timer">Score = 01</button>
 <form method="post">
   ...
   %></p></center>
   <center><p><% 
	String msg1 = (String)session.getAttribute("D");
	if(msg1!=null)
	out.print(msg1);
   ...
   %></p></center>
	    <div class="head">
		    ...
		    <h2> QUESTION 2</h2>
		     <p id="ques">------------The other name for main memory------------</p>
	    </div>

        <div class="list">
                <ul style="list-style-type:none">
                    <button class="button"><li><a href="quit.jsp" id="line" >Primary Memory</a></li></button>
                    <button class="button"><li><a href="quit.jsp" id="line" > ROM </li></a></button>
            </ul>
            <ul style="list-style-type:none" >
            
                <button class="button" name="sc" onclick="this.form.action = 'score1.jsp'"><li><id="line">RAM</id></li></button>
                <button class="button"><li><a href="quit.jsp" id="line" >Secondary Memory</a> </li></button>
            </ul>
        </div>
        </form>
	...
	while(rs.next())
	{
        ...
        window.onclick = function(event) {
            if (event.target == modal) {
				...
				{
					System.out.print("hy");
					session.setAttribute("D","Hint have been used once"); 
					%>
					<script>var btn = document.getElementById("hint");
					btn.onclick=function()
					{
