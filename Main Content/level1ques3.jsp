...
<button id="timer">Score = 02</button>
   ...
   %></p></center>
   <center><p><% 
	String msg1 = (String)session.getAttribute("F");
	if(msg1!=null)
	out.print(msg1);
   ...
   <div class="head">
		    ...
		    <h2> QUESTION 3</h2>
		     <p id="ques">-------------Two types of commonly used printers------------</p>
	    </div>

        <div class="list">
                <ul style="list-style-type:none">
                    
                    <button class="button"><li><a href="quit.jsp" id="line" >Ink-jet and Dot Matrix printer</a></li></button>
                    <button class="button"><li><a href="quit.jsp" id="line" >Line printers and Laser printer</a></li></button>
            </ul>
            <ul style="list-style-type:none" >
            
                <button class="button" name="sc" onclick="this.form.action = 'score2.jsp'"><li><id="line" >Dot matrix and Laser printer</id></li></button>
                <button class="button"><li><a href="quit.jsp" id="line" >Line and Ink-jet printers</a></li></button>
            </ul>
        </div>
        </form>
	...
	while(rs.next())
	{
        ...
        window.onclick = function(event) {
            if (event.target == modal) {
				...
				{
					System.out.print("hy");
					session.setAttribute("F","Hint have been used once"); 
					%>
					<script>var btn = document.getElementById("hint");
					btn.onclick=function()
					{
