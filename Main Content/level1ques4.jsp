...
<form method="post">
   ...
   %></p></center>
   <center><p><% 
	String msg1 = (String)session.getAttribute("H");
	if(msg1!=null)
	out.print(msg1);
   ...
   %></p></center>
    <div class="head">
		    ...
		    <h2> QUESTION 4</h2>
		     <p id="ques">----Number of generations computer can be classified into----</p>
	    </div>

        <div class="list">
                <ul style="list-style-type:none">
                    
                    <button class="button"><li><a href="quit.jsp" id="line" >3</a><li></button>
                    <button class="button"><li><a href="quit.jsp" id="line" >4</a></li></button>
            </ul>
            <ul style="list-style-type:none" >
            
                <button class="button" name="sc" onclick="this.form.action = 'score3.jsp'"><li><id="line" >5</id></li></button>
                <button class="button"><li><a href="quit.jsp" id="line" >6</a></li></button>
            </ul>
        </div>
        </form>
	...
	while(rs.next())
	{
        ...
        window.onclick = function(event) {
            if (event.target == modal) {
				...
				{
					System.out.print("hy");
					session.setAttribute("H","Hint have been used once"); 
					%>
					<script>var btn = document.getElementById("hint");
					btn.onclick=function()
					{
