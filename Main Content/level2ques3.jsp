...
<form method="post">
   ...
   %></p></center>
   <center><p><% 
	String msg1 = (String)session.getAttribute("N");
	if(msg1!=null)
	out.print(msg1);
   ...
   %></p></center>   
	    <div class="head">
		    ...
		    <h2> QUESTION 3</h2>
		     <p id="ques">----One of the following is not a reserved keyword for C++----</p>
	    </div>
        <div class="list">
                <ul style="list-style-type:none">
                    <button class="button" name="sc" onclick="this.form.action = 'score6.jsp'"><li><id="line">main</id></li></button>
                    <button class="button"><li><a href="quit.jsp" id="line" >auto</li></a></button>
            </ul>
            <ul style="list-style-type:none" >
                <button class="button"><li><a href="quit.jsp" id="line" >case </li></a></button>
                <button class="button"><li><a href="quit.jsp" id="line" > register</li></a></button>
            </ul>
        </div>
        </form>
	...
	while(rs.next())
	{
        ...
        window.onclick = function(event) {
            if (event.target == modal) {
				...
				{
					System.out.print("hy");
					session.setAttribute("N","Hint have been used once"); 
					%>
					<script>var btn = document.getElementById("hint");
					btn.onclick=function()
					{
