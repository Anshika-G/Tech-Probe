...
<form method="post">
   ...
   %></p></center>
   <center><p><% 
	String msg1 = (String)session.getAttribute("P");
	if(msg1!=null)
	out.print(msg1);
   ...
   %></p></center>   
	    <div class="head">
            ...
            <h2> QUESTION 4</h2>
		     <p id="ques">--For 16-bit compiler, allowable range for integer constants:--</p>
	    </div>
        <div class="list">
                <ul style="list-style-type:none">
                    <button class="button"  name="sc" onclick="this.form.action = 'score7.jsp'"><li><id="line">-32768 to 32767</id></li></button>
                    <button class="button"><li><a href="quit.jsp" id="line" >-3.4e38 to 3.4e38</a></li></button>
            </ul>
            <ul style="list-style-type:none" >
                <button class="button"><li><a href="quit.jsp" id="line" >-32767 to 32768</a></li></button>
                <button class="button"><li><a href="quit.jsp" id="line" >-32668 to 32667</a></li></button>
            </ul>
        </div>
        </form>
	...
	while(rs.next())
	{
        ...
        window.onclick = function(event) {
            if (event.target == modal) {
				...
				{
					System.out.print("hy");
					session.setAttribute("P","Hint have been used once"); 
					%>
					<script>var btn = document.getElementById("hint");
					btn.onclick=function()
					{
