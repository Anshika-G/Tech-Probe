...
<form method="post">
  <center><p><% 
   ...
   %></p></center>
   <center><p><% 
	String msg1 = (String)session.getAttribute("T");
	if(msg1!=null)
	out.print(msg1);
   ...
   %></p></center>
	    <div class="head">
		    ...
		    <h2> QUESTION 2</h2>
		     <p id="ques"> ----------------------Cout is a/an----------------------</p>
	    </div>

        <div class="list">
                <ul style="list-style-type:none">
                    
                    <button class="button"><li><a href="quit.jsp" id="line" >operator</a></li></button></br>
                    <button class="button" name="sc" onclick="this.form.action = 'score9.jsp'"><li><id="line" >object</id></li></button>
            </ul>
            <ul style="list-style-type:none" >
            
                <button class="button"><li><a href="quit.jsp" id="line" >function </a></li></button>
                <button class="button"><li><a href="quit.jsp" id="line" >macro</a></li></button>
            </ul>
        </div>
        </form>
	...
	while(rs.next())
	{
        ...
        window.onclick = function(event) {
            if (event.target == modal) {
				...
				{
					System.out.print("hy");
					session.setAttribute("T","Hint have been used once"); 
					%>
					<script>var btn = document.getElementById("hint");
					btn.onclick=function()
					{
