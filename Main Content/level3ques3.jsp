...
<form method="post">
  <center><p><% 
   ...
   %></p></center>
   <center><p><% 
	String msg1 = (String)session.getAttribute("V");
	if(msg1!=null)
	out.print(msg1);
   ...
   %></p></center>
	    <div class="head">
		    ...
		    <h2> QUESTION 3</h2>
		     <p id="ques">---If a function contains two successive 'return' statements <br><br><br> &emsp;&emsp;the compiler generates warning---</p>
	    </div>

        <div class="list">
                <ul style="list-style-type:none">
                    
                    <button class="button" name="sc" onclick="this.form.action = 'score10.jsp'"><li><id="line" >Yes</id><li></button></br>
                    <button class="button"><li><a href="quit.jsp" id="line" >No</a></li></button>
            </ul>
            <ul style="list-style-type:none" >
            
                <button class="button"><li><a href="quit.jsp" id="line" >Depends on language used</a></li></button>
                <button class="button"><li><a href="quit.jsp" id="line" >Depends on compiler used</a></li></button>
            </ul>
        </div>
        </form>
	...
	while(rs.next())
	{
        ...
        window.onclick = function(event) {
            if (event.target == modal) {
				...
				{
					System.out.print("hy");
					session.setAttribute("V","Hint have been used once"); 
					%>
					<script>var btn = document.getElementById("hint");
					btn.onclick=function()
					{
