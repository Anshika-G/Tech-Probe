...
<form method="post">
  <center><p><% 
   ...
   %></p></center>
   <center><p><% 
	String msg1 = (String)session.getAttribute("Z");
	if(msg1!=null)
	out.print(msg1);
   ...
   %></p></center>
   		<div class="head">
		    ...
		    <h2> QUESTION 1</h2>
		     <p id="ques">---In linear search algorithms, the worst case occurs,when---</p>
	    </div>

        <div class="list">
                <ul style="list-style-type:none">
                    <button class="button"><li><a href="quit.jsp" id="line" >The item is somwhere in the middle of the array.</a></li></button>
                    <button class="button"><li><a href="quit.jsp" id="line" >The item is not in the array at all.</a></li></button>
            </ul>
            <ul style="list-style-type:none" >
                <button class="button"><li> <a href="quit.jsp" id="line" >The item is the last element in the array.</a></li></button>
                <button class="button" name="sc" onclick="this.form.action = 'score12.jsp'"><li><id="line">The item is the last element in the array or is not there at all.</id></li></button>
            </ul>
        </div>
        </form>
	...
	while(rs.next())
	{
        ...
        window.onclick = function(event) {
            if (event.target == modal) {
				...
				{
					System.out.print("hy");
					session.setAttribute("Z","Hint have been used once"); 
					%>
					<script>var btn = document.getElementById("hint");
					btn.onclick=function()
					{
