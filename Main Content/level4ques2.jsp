...
<form method="post">
  <center><p><% 
   ...
   %></p></center>
   <center><p><% 
	String msg1 = (String)session.getAttribute("On");
	if(msg1!=null)
	out.print(msg1);
   ...
   %></p></center>
	    <div class="head">
		    ...
		    <h2> QUESTION 2</h2>
		     <p id="ques">---Two main measures for the efficiency of an algorithm are---</p>
	    </div>

        <div class="list">
                <ul style="list-style-type:none">
                    <button class="button"><li><a href="quit.jsp" id="line" >Processor and memory</a></li></button>
                    <button class="button"><li><a href="quit.jsp" id="line" >Complexity and capacity</a></li></button>
            </ul>
            <ul style="list-style-type:none" >
                <button class="button" name="sc" onclick="this.form.action = 'score13.jsp'"><li><id="line">Time and Space</id></li></button></br>
                <button class="button"><li><a href="quit.jsp" id="line" >Data and space</a></li></button>
            </ul>
        </div>
        </form>
	...
	while(rs.next())
	{
        ...
        window.onclick = function(event) {
            if (event.target == modal) {
				...
				{
					System.out.print("hy");
					session.setAttribute("On","Hint have been used once"); 
					%>
					<script>var btn = document.getElementById("hint");
					btn.onclick=function()
					{
