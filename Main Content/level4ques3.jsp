...
<form  method="post">
  <center><p><% 
   ...
   %></p></center>
   <center><p><% 
	String msg1 = (String)session.getAttribute("BBB");
	if(msg1!=null)
	out.print(msg1);
   ...
   %></p></center>
	    <div class="head">
		    ...
		    <h2> QUESTION 3</h2>
		    <p id="ques">------One of the following is the linear data structure------</p>
	    </div>

        <div class="list">
                <ul style="list-style-type:none">
                    <button class="button"><li><a href="quit.jsp" id="line" >Tree</a></li></button>
                    <button class="button"><li><a href="quit.jsp" id="line" >Graph</a></li></button>
            </ul>
            <ul style="list-style-type:none" >
                <button class="button" name="sc" onclick="this.form.action = 'score14.jsp'"><li><id="line">Array</id></li></button>
                <button class="button"><li><a href="quit.jsp" id="line" >None of the above</a></li></button>
            </ul>
        </div>
        </form>
	...
	while(rs.next())
	{
        ...
        window.onclick = function(event) {
            if (event.target == modal) {
				...
				{
					System.out.print("hy");
					session.setAttribute("BBB","Hint have been used once"); 
					%>
					<script>var btn = document.getElementById("hint");
					btn.onclick=function()
					{
