...
<form method="post">
  <center><p><% 
   ...
   %></p></center>
   <center><p><% 
	String msg1 = (String)session.getAttribute("DDD");
	if(msg1!=null)
	out.print(msg1);
   ...
   %></p></center>
	    <div class="head">
		    ...
		    <h2> QUESTION 4</h2>
		    <p id="ques">---The following case does not exist in complexity theorem---</p>
	    </div>

        <div class="list">
                <ul style="list-style-type:none">
                    <button class="button"><li><a href="quit.jsp" id="line" >Best case</a></li></button>
                    <button class="button"><li><a href="quit.jsp" id="line" >Worst case</a></li></button>
            </ul>
            <ul style="list-style-type:none" >
                <button class="button"><li><a href="quit.jsp" id="line" >Average case</a></li></button>
                <button class="button" name="sc" onclick="this.form.action = 'score15.jsp'"><li><id="line">Null case</id></li></button>
            </ul>
        </div>
        </form>
	...
	while(rs.next())
	{
        ...
        window.onclick = function(event) {
            if (event.target == modal) {
				...
				{
					System.out.print("hy");
					session.setAttribute("DDD","Hint have been used once"); 
					%>
					<script>var btn = document.getElementById("hint");
					btn.onclick=function()
					{
